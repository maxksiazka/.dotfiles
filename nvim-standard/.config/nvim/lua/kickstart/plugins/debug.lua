...
return {
    ...
    config = function()
        ...
        vim.keymap.set('n', '<F12>', dap.clear_breakpoints, { desc = 'Debug: Clear All Breakpoints' })

        -- Dap UI setup
        -- For more information, see |:help nvim-dap-ui|
        --@ignore_diagnostics: missing_fields
        dapui.setup {
        ...
        -- INFO: Configs for different languages below;
        dap.adapters.gdb = {
            type = 'executable',
            command = 'gdb',
        ...
        dap.configurations.c = {
            {
                ...
                cwd = '${workspaceFolder}',
                stopAtBeginnningOfMainSubprogram = false,
            },
            {
                name = 'Attach',
                type = 'gdb',
